            ...
            if (isExpanded) ...[
              ...
              Expanded(
                child: DataTable(
                  ...
                  DataColumn(
                  label: Text('Recipiente', style: TextStyle(color: Colors.white),),
                  ),
                  DataColumn(
                  ...
                  DataRow(
                  cells: <DataCell>[
                        DataCell(Text('01/01/2023', style: TextStyle(color: Colors.white),)),
                        DataCell(Text('Recipiente 1', style: TextStyle(color: Colors.white),)),
                        DataCell(Text('100 ml', style: TextStyle(color: Colors.white),)),
                  ],
                  ),
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  children: [
                      Icon(widget.firstIcon.icon, color: isExpanded ? Colors.white : const Color(0xFF20A4F3)),
                      Text(widget.firstText.data ?? "", style: TextStyle(color: isExpanded ? Colors.white : const Color(0xFF20A4F3)))
                  ],
                  ),
                  GestureDetector(
                  onTap: () {
                  ...
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                      Icon(widget.secondIcon.icon, color: isExpanded ? const Color(0xFF20A4F3) : Colors.white),
                      Text(widget.secondText.data ?? "", style: TextStyle(color: isExpanded ? const Color(0xFF20A4F3) : Colors.white))
                  ],
                  ),
                  ),
                ],
